...
/**
     * DICHIARAZIONE VARIABILI DELLE 
     * COMPONENTI RELATIVE ALL'HTML
     * id form
     * id input
     * id btn
     * id list
...
window.onload = function() {
	...
	// listItem = {item: "tutti gli item", checked: FALSO}
	var liItem = "";
	var todoList = [];

	//bottone per creare l'evento con il click
